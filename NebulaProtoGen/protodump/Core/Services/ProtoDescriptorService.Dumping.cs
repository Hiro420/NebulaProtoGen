...
{
	const string NebulaNamespacePrefix = "emu.nebula.proto";
	...
	void DumpFileDescriptor(FileDescriptorProto proto, StringBuilder sb)
	{
		...
		sb.AppendLine("// Generated by NebulaProtoGen.  DO NOT EDIT!");
		...
		// ADDITION SPECIAL TO NEBULA PROTOS
		options["java_package"] = Util.ToLiteral(NebulaNamespacePrefix);
