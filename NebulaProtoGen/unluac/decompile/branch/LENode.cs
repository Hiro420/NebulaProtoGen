...
namespace unluac.decompile.branch
{
	public class LENode : Branch
	{
		...
		public LENode(int left, int right, bool invert, int line, int begin, int end) : base(line, begin, end) { this.left = left; this.right = right; this.invert = invert; }
		public override Branch Invert() { return new LENode(left, right, !invert, line, end, begin); }
